...
include_once 'dbconnect.php';
 ...
 $res=mysqli_query($con,"SELECT * FROM customer JOIN vehicle ON customer.v_id=vehicle.v_id");
?>
	...
	<div >
		...
		while ($Row = mysqli_fetch_assoc($res)) { ?>
			...
			<div>
				...
				<p>Customer Name:   <?php echo $Row['cf_name']; ?><p>
				<p>Mobile:   <?php echo $Row['c_mobile']; ?><p>
